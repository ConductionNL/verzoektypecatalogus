# verzoektypecatalogus chart

The Helm chart installs verzoektypecatalogus and by default the following dependencies using subcharts:
...
```bash
helm repo add verzoektypecatalogus https://raw.githubusercontent.com/ConductionNL/verzoektypecatalogus/master/api/helm/
helm repo update
```
...
```bash
helm install my-verzoektypecatalogus ConductionNL/verzoektypecatalogus --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `verzoektypecatalogus` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `verzoektypecatalogus` |
